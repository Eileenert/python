...
class Interface(tk.Frame):
    def __init__(self, **kwargs):
        tk.Frame.__init__(self, borderwidth=5, padx=75, pady=25, **kwargs)

        self.configure(bg="#0d0d0d")
        self.master.configure(bg="#0d0d0d")
        ...
        self.display_area = tk.Entry(self,
                                     textvariable=self.var_text,
                                     font=("Helvetica", 15),
                                     bg="#f2f2f2")  # display area
        self.display_area.grid(columnspan=6,
                               ipadx=350,
                               ipady=15,
                               pady=10,
                               padx=20)
        ...
        # point button
        self.button_point = tk.Button(self,
                                      text=".",
                                      height=5,
                                      width=15,
                                      font=("Helvetica", "10", "bold"),
        ...
        # percent button
        self.button_percent = tk.Button(self,
                                        text="%",
                                        height=5,
                                        width=15,
                                        font=("Helvetica", "10", "bold"),
        ...
        # division button
        self.button_division = tk.Button(self,
                                         text="÷",
                                         height=5,
                                         width=15,
                                         font=("Helvetica", "10", "bold"),
        ...
        self.button_multiplication = tk.Button(self,
                                               text="×",
                                               height=5,
                                               width=15,
                                               font=("Helvetica", "10",
        ...
        # substraction button
        self.button_substraction = tk.Button(self,
                                             text="-",
                                             height=5,
                                             width=15,
                                             font=("Helvetica", "10", "bold"),
        ...
        # addition button
        self.button_addition = tk.Button(self,
                                         text="+",
                                         height=5,
                                         width=15,
                                         font=("Helvetica", "10", "bold"),
        ...
        # equal button
        self.button_equal = tk.Button(self,
                                      text="=",
                                      height=5,
                                      width=15,
                                      font=("Helvetica", "10", "bold"),
                                      command=self.equal_press)
